...
class App(ctk.CTk):
    ...
    def _setup_sidebar(self):
        ...
        self.sublog_label = ctk.CTkLabel(
            self.sidebar_frame,
            text="Fast & Reliable",
        ...
        self.donation_btn = ctk.CTkButton(
            self.sidebar_frame,
    ...
    def _setup_main_content(self):
        ...
        self.header_frame = ctk.CTkFrame(
            self.main_container, fg_color=("gray85", "gray14"), corner_radius=15
        )
        ...
        self.settings_frame = ctk.CTkFrame(
            self.content_card, fg_color=("gray90", "gray12"), corner_radius=12
        )
    ...
    def start_download(self):
        ...
        if not url or not outdir:
            messagebox.showwarning(
                "Input Error", "Please provide a valid URL and Output Folder."
            )
            return
        ...
        thread = threading.Thread(
            target=self._worker, args=(url, outdir, kind), daemon=True
        )
        thread.start()
